/*
 * This file is included in order to give correct links to the developers
 *
 ...
 */
/**
 * @page developers VANTAGE Software Developers
 *
 * @section nwr Nicholas Renninger
 *
 * - Incompetent 
 * - nicholas.renninger@colorado.com
 * - Cats are the best type of pet
 */
